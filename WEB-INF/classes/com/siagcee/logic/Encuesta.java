...
public class Encuesta extends Objeto{
	...
	public Encuesta(Usuario _usuario, Connection _miConexion, int _idEncuesta){
	...
	private void recargaDeBd(){
		ResultSet rs = null;
		try {
			PreparedStatement pstmt = this.getConexion().prepareStatement("SELECT * FROM pool_objetos WHERE id_pool_objetos = ? AND tipo_objeto = 2");
