...
public class _adminlogin__jsp extends com.caucho.jsp.JavaPage{
  ...
  if (request.getParameter("error") != null){
    out.println(request.getParameter("error")+"<br />");
  }
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("adminlogin.jsp"), 5088099132242630492L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
