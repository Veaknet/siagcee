...
public class _correos_0a_0invitar__jsp extends com.caucho.jsp.JavaPage{
...
SimpleDateFormat _dateFormat = new SimpleDateFormat("dd/MM/yyyy");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/vistas/correos_a_invitar.jsp"), -4325146487354850493L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/vistas/admininicio.jsp"), -2698818426022610974L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("WEB-INF/vistas/adminheader.jsp"), -3187249410477463010L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
