...
language['Html']  = "HTML";
language['Spellcheck']  = "Comprobar ortografia";
language['Select some text first'] = "Selecciona algun texto primero";
...
language['Image address (URL)']  = "Direccion de la imagen (URL)";
language['Link address (URL)']  = "Direccion del enlace(URL)";
...
language['ieSpell is not installed on your computer.']  = "ieSpell no esta instalado en tu ordenador.";
language['Click [OK] to go to download page.']  = "Haz click en [Aceptar] para ir a la pagina de descarga.";
language['Click [OK] for instructions to download and install']  = "Haz click en [Aceptar] para instrucciones de descarga e instalacion de";
...
language["click in the edit area and select 'Check Spelling'."]  = "haz click en el area de edicion y selecciona 'Check Spelling'(Comprobar ortografia)";